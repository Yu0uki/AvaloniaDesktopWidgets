...
> **版本**: v3.0.0 | **框架**: Avalonia UI 11.x | **.NET**: 10.0
...
### 示例插件 - 世界时钟
![世界时钟插件](pic/示例插件-时钟.jpg)

### 世界时钟 - 设置页面
![时钟设置](pic/示例插件-时钟-设置.jpg)

### 世界时钟 - 独立窗口
![时钟弹出窗口](pic/示例插件-时钟-弹出窗口.jpg)

## ✨ 主要特性

### 🎨 现代化 UI/UX
- **主题切换**: 支持深色、浅色和跟随系统三种主题模式
